...
#include <AltSoftSerial.h>  //header file of alternative software serial port

AltSoftSerial mySerial; //define software serial port name as Serial1 and define respetively RX and TX
...
{ 
  if (mySerial.available()) {  //check if serial port has data input
    ...
    {
      //Serial.println("primo bit diverso da 0x59");
    }
  }
  //delay(10);
